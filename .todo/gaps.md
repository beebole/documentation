...
Result: **0 Missing, 8 Partial** across 6 sections. One touched entry was already covered: `notifications/triggers` (approval requests reaching parent-project managers) is stated on `help/documentation/approval.mdx:71`.
