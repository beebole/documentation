...
**Do NOT read** `feedback.md`. That file holds English content-authoring rules; applying them during translation would bleed content feedback into the translation pipeline. Translation feedback lives exclusively in `translation-notes.md`.
