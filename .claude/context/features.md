...
- `reports/schedule-email` **Scheduled report delivery** — Email a saved report to chosen recipients on a recurring schedule. _(status: hidden-flag — the **Schedule** action is gated off in production builds; do NOT document until it ships. Flagged 2026-08-24)_
