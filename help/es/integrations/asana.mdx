...
<Steps>
    <Step title="Conectarse a Asana">Ve a **Configuración >> Integraciones >> Asana**. Haz clic en el botón para conectarte a tu cuenta de Asana.<br/><img src="/help/images/integrations/asana-connect.webp" className="rounded-lg" style={{width: "600px", height: "auto"}}/><br/>
    ...
    Define si deseas importar tus tareas para Planificación y asignación o para seguimiento de tiempo por proyecto y tarifas.<br/><img src="/help/images/integrations/asana-params.webp" className="rounded-lg" style={{width: "500px", height: "auto"}}/></Step>
    ...
    _Ten en cuenta que esto puede tardar unos momentos dependiendo de tu cuenta de Asana_.<img src="/help/images/integrations/asana-updating.webp" className="rounded-lg" style={{width: "300px", height: "auto"}}/>
