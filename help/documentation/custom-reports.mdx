...
<Steps>
  ...
  <Step title="Choose a dimension">
    Select the type of record you want to analyze. Your choice determines the available columns and filters. See [Add output columns](#add-output-columns) below.
  </Step>
  ...
  <Step title="Apply filters">
    Narrow the report to specific people, projects, tags, date ranges, or custom field values. See [Filter and scope the data](#filter-and-scope-the-data) below.
  </Step>
