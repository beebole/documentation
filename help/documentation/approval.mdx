---
title: "Timesheet and time off approval workflows"
...
keywords: ["beebole", "timesheet approval", "approval workflow", "multi-stage approval", "approve timesheets", "reject timesheet", "reopen approved timesheet", "approve on mobile", "time off approval"]
...
Approvers can act from four places: the **Timesheet** page, the **Journal**, directly from email, or from a phone.
...
On a phone, the approval panes become a bottom sheet. Managers and administrators see a team icon in the header with a badge counting pending approvals; tapping it opens the same **Pending** and **Team** tabs, and **Approve** and **Reject** sit in the header of the timesheet you open, with bulk actions for several at once. The team icon only appears for people who can approve or review timesheets — if all you see are your own tracking controls, your role has no one to review. See [Approving team timesheets on mobile](/help/documentation/mobile#approving-team-timesheets-on-mobile).
...
To reach an approved timesheet, open it from the **Team** pane, not the **Pending** pane: **Pending** only lists submissions still waiting for a decision, so an approved period is never there. Pick the person in **Team**, navigate to the approved period, and **Reject** appears at the top of their timesheet. Rejecting unlocks the period for its owner, who corrects the entries and clicks **Resubmit**. To fix an entry without sending the whole period back, use the edit button (**Edit timesheet**) described above instead.
...
<AccordionGroup>
  ...
  <Accordion title="How do I reopen an approved timesheet so its owner can edit it?">
    Reject it. In Beebole an administrator — or an approver of the timesheet's last stage — can reject an already-approved period, which unlocks it for its owner. Open the person from the **Team** pane of the timesheet (the **Pending** pane only shows submissions still awaiting approval), go to the approved period, click **Reject**, and enter the reason. If you only need to correct an entry yourself, click the edit button (**Edit timesheet**) on the person's row instead — administrator edits don't reopen the workflow.
  </Accordion>
  <Accordion title="Can I approve timesheets from my phone?">
    Yes. On a phone, Beebole shows approvers a team icon in the header with the number of pending submissions. It opens a sheet with the **Pending** and **Team** tabs, and **Approve** and **Reject** appear in the header of the timesheet you open. The icon is absent for people who have nobody to review. See [Mobile and tablet](/help/documentation/mobile#approving-team-timesheets-on-mobile).
  </Accordion>
  <Accordion title="Can I reject a single time entry instead of the whole timesheet?">
    No. Beebole's approval acts on the timesheet period as a whole: **Reject** sends the entire submitted period back to its owner with your reason, and they resubmit once corrected. To change one entry without rejecting, approvers of the current stage and administrators can edit the entry directly with the edit button (**Edit timesheet**) on the person's row — see [Editing a submitted or approved timesheet](#editing-a-submitted-or-approved-timesheet).
  </Accordion>
</AccordionGroup>
