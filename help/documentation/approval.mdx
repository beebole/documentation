...
<Info>
  The restriction **Only the owner or an admin can edit entries** in [Timesheet and Planning Settings](/help/documentation/timesheetSettings) removes the approver column above — only the owner and administrators can then change entries.
</Info>
