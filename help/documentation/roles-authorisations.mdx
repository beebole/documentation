...
| **Assign tasks** | Assigning tasks to people |
| **Assign projects** | Assigning people to projects |
...
<AccordionGroup>
  ...
  <Accordion title="How do I check which role I have?">
    People with the Admin role can open **People** in the sidebar, open their own profile, and read the current role from the **Email & role** panel. Everyone else has to ask an administrator, because Beebole does not show a person's role in their own user menu. An administrator can look it up in the same **Email & role** panel on that person's profile.
  </Accordion>
