...
- **Week**, **2 weeks**, **3 weeks**, **4 weeks**, or **6 weeks** — the chart fits that many weeks to your screen and lists only the tasks that fall inside the window (parents and recurring series are kept).
