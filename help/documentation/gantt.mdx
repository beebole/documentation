...
- **Day**, **Week**, **2 weeks**, **3 weeks**, **4 weeks**, or **6 weeks** — the chart fits that window to your screen and lists only the tasks that fall inside it (parent tasks are kept).
...
| **⌘+Arrow** | Add the task you land on to the selection, or drop it, like **⌘+Click** (Ctrl on Windows and Linux) |
