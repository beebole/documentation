---
title: "Google Sheets Add-on: Link Sheets to Reports — Beebole"
...
To remove a link, click the **✕** button next to it in the table. This removes the link only — the sheet and its current data stay in place.
