...
<Info>
  Cost rates are available on higher-tier Beebole plans. Who can view and edit them is controlled by the **Costs** permission — see [Roles & permissions](/help/documentation/roles-authorisations).
</Info>
...
Cost rates live in the **Cost** section of an entity's settings panel — the same panel where [billing rates](/help/documentation/billing) are configured. You can set them at four levels:
...
<Steps>
  <Step title="Open the Cost section">
    Open the organization (**Settings** > **Account Settings**), or click **Tags**, **Projects**, or **People** in the sidebar and then the entity's name. Scroll to **Cost**.
  </Step>
