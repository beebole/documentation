...
<AccordionGroup>
  ...
  <Accordion title="Does time off count toward costs?">
    Yes. Time off is valued with the person's cost rate for the day and included in their cost totals in reports and budgets, the same way a regular time entry is. It never carries a billing amount.
  </Accordion>
