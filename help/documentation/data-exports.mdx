---
title: "Data exports: CSV, Excel, PDF, and JSON"
...
keywords: ["Beebole data export", "export CSV", "export Excel", "export PDF", "download report", "export time data", "reporting export", "beebole", "gdpr", "personal data", "right to erasure", "data deletion request"]
...
<AccordionGroup>
  ...
  <Accordion title="Why do some characters print as question marks in a PDF export?">
