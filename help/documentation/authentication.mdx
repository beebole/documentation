---
title: "Sign-in, passkeys, SSO, and API keys — Beebole"
...
| Google or Microsoft | You sign in through your existing Google or Microsoft account | None for the person; an admin links the domain for SSO enforcement |
