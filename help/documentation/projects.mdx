...
The fields shown in the **Custom fields** panel come from the field definitions in your account — you fill in values there, but you create and scope the fields themselves in **Settings** \> **Custom Field**. Custom field values appear as dimensions and filters in [reports](/help/documentation/reports).
