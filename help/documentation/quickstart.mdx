---
title: "Quickstart: set up your time tracking account — Beebole"
...
<Steps>
  ...
  <Step title="Refine and share">
    Open the report's **⋯** action menu to change the date range with **Period**, download the results with **Export**, or send a link with **Share**.
  </Step>
</Steps>
