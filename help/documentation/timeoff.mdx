...
<div style={{position: "relative", paddingBottom: "calc(58.6934% + 41px)", height: "0px", width: "100%"}}>
  <iframe src="https://demo.arcade.software/ES36S84RdgWOOnlf030h?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="Add Time Off Types" frameBorder="0" loading="lazy" allowFullScreen allow="clipboard-write" style={{position: "absolute", top: 0, left: 0, width: "100%", height: "100%", colorScheme: "light"}} />
</div>
