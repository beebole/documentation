---
title: "Billing rates: turn tracked time into revenue — Beebole"
...
Billing rates live in the **Billing** section of an entity's settings panel. You can set them at four levels: organization, tag, project, and person.
...
<Steps>
  <Step title="Open the Billing section">
    In the entity's settings panel, scroll to **Billing**.
  </Step>
...
With an **Hourly rate** or **Daily rate**, you can replace the single amount with per-entity amounts. The split options are:
