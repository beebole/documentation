...
<Steps>
  ...
  <Step title="Track status">
    The profile shows an **Invitation pending** status until the person completes their sign-up. Once they have joined, the invitation option no longer appears on their profile, since they can already sign in.
  </Step>
</Steps>
...
<AccordionGroup>
  ...
  <Accordion title="Why don't I see the Invite by email button on someone's profile?">
    The invitation option only appears for people who have not joined yet. If the person's profile no longer shows it, they have already accepted their invitation and can sign in. A profile showing **Invitation pending** means the invitation was sent but not yet accepted; you can resend it from the profile.
  </Accordion>
