...
keywords: ["Beebole journal", "activity feed", "team messages", "notifications feed", "team communication", "mentions", "beebole"]
...
<CardGroup cols={2}>
  <Card title="Notifications" href="/help/documentation/notifications">
