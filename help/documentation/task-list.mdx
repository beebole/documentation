...
<Frame caption="The List view showing tasks as a sortable table with owner, dates, and status columns">
  ![Beebole List view showing tasks in a sortable table with columns for owner, dates, planned time, and status](/help/images/planning/task-list-view.webp)
</Frame>
