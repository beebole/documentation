...
| Area | Effect |
|------|--------|
| **Timesheets** | Public holidays are highlighted on the timesheet with a hatched pattern over the day column, and the holiday's name appears when you hover the day header. Depending on your settings, people may or may not be required to log time on these days. |
