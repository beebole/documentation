...
<Steps>
  ...
  <Step title="Select a country">
    Click **Load holidays** and choose the country from the list. Beebole populates the calendar with that country's official public holidays for the current year.
  </Step>
