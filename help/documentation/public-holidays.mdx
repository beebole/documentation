...
description: "Set up country-specific public holiday calendars and add custom holidays for your team in Beebole, including per-branch overrides and per-employee exceptions."
...
<CardGroup cols={2}>
  <Card title="Time Off" icon="calendar" href="/help/documentation/timeoff">
    Configure absence types and quotas that work alongside public holidays.
  </Card>
