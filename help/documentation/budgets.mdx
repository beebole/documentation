...
<AccordionGroup>
  ...
  <Accordion title="Does Beebole alert me when a budget is exceeded?">
    Yes. Beebole alerts you when a budget passes its alert threshold (80% by default) and again when it goes over budget. Alert badges appear on the budget itself, and the **Budget Status** report flags at-risk and over-budget projects.
  </Accordion>
