...
| **Billing and cost rates** | The full dated rate history, including rates split per person and per subproject |
...
| **Time records** | Historical entries with their hours, billability, and clock-in and clock-out times when legacy stored them |
