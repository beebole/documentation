...
<Steps>
  ...
  <Step title="Review the audit results and choose what to migrate">
    The **Audit Results** screen shows a breakdown of records found in your legacy account, with a live count per data type. Under **What to migrate** and **Data that links them**, untick anything you don't want to bring over — people, projects, tags, schedules, budgets, time records, the manager structure, and more are individually selectable. Review the counts and the time record date range before proceeding.
  </Step>
