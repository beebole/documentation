...
- People who have never recorded time are counted separately in a footnote — the timesheet process has not started for them, so they aren't shown as non-submitters. Click the footnote to expand the list of exactly who hasn't started tracking time.
