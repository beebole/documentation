...
Next to **Budget Status**, the Reports menu offers **Planned vs. Real** — a chart comparing the work you planned with the hours actually logged, period by period.
...
Use it to catch plans drifting from reality early — a **Real** line running above **Planned** means the work costs more time than scheduled. Plan the work itself in the [Gantt](/help/documentation/gantt) and [Staffing](/help/documentation/staffing) views.
