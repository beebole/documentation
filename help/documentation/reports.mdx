...
This report is where budget trouble surfaces: it always flags projects approaching or over their budget, with a burn-rate forecast of when a budget would run out, and there is no setting to switch on. See the [Budgets](/help/documentation/budgets) page for how budgets and their thresholds are set.
