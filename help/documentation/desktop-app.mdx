...
<Steps>
  ...
  <Step title="Install and launch">
    Run the installer and open the app. Signing in from the app hands off to your browser — complete the sign-in there with any method, [passkeys and SSO included](/help/documentation/authentication), and you return to the app signed in. You can also connect it from the **Assistant** page in your browser: when Beebole detects the running app, it links it to your account automatically by syncing your API key. Use **Open the desktop app** on the same page to bring it up anytime.
  </Step>
</Steps>
