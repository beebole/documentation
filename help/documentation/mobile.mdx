...
- **Open it first** — Tap the row itself to open it in a sheet, where you can change the duration, set or clear the start and end times, point it at another task or working activity, or start a timer on it.
- **Dismiss it** — Tap the bin on the row. Dismissed suggestions never become entries.
