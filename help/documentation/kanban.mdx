...
Beebole's Kanban board displays your [tasks](/help/documentation/planning) as cards in columns — one column per status of the planning. Drag a card to another column to change its status as work progresses, for example from **Backlog** to **In progress** to **Done**. The Kanban board is one of the three views of the **Planning** page, alongside the [Gantt chart](/help/documentation/gantt) and the [Staffing view](/help/documentation/staffing) — all show the same tasks, so a change in one view appears instantly in the others.
