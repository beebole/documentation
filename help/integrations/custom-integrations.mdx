---
title: "Custom Integrations via GraphQL API — Beebole"
...
<Tip>Start with a read-only integration (queries only) to validate your data mapping before writing data back to Beebole.</Tip>
