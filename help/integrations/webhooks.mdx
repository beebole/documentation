...
```json
{
  ...
  "organizationId": "63f9a1b2c3d4e5f6a7b8c9d0"
}
```
...
| `organizationId` | The Beebole organization ID that the event belongs to. |
...
| `organizationUpdate` | Organization settings are changed. |
