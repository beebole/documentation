...
<Info>You need administrative privileges in both Monday.com and Beebole to set up the integration.</Info>
...
<Steps>
  ...
  <Step title="Enable the integration">
    ...
    <Info>The initial import may take a few moments depending on the size of your Monday.com workspace. You can continue using Beebole while the import runs in the background.</Info>
