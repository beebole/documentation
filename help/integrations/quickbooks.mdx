...
<Steps>
  ...
  <Step title="Connect to QuickBooks">
    Locate the **QuickBooks** card and click **Connect**. A pop-up appears asking you to sign in to your QuickBooks Online account and authorize Beebole to send data.
  </Step>
  <Step title="Connect to QuickBooks Online">
    Click **Connect to QuickBooks Online**. A popup appears asking you to sign in to your QuickBooks Online account and authorize Beebole to send data.
  </Step>
...
While the integration is enabled, customers and items created or renamed in QuickBooks are reflected in Beebole automatically. To pull the latest changes on demand, go to **Settings** \> **Integrations** \> **QuickBooks Online** and click **Manual sync** under **Manually sync QuickBooks customers and items**.
