...
<Steps>
    <Step title="Connect to Asana">Go to **Settings >> Integrations >> Asana**. Click on the button to connect to your Asana account.<br/><img src="/help/images/integrations/asanaconnect.webp" className="rounded-lg" style={{width: "600px", height: "auto"}}/><br/>
    ...
    Define whether you want to import your tasks for Planning and assignment or for project time tracking and rates.<br/><img src="/help/images/integrations/asanaparams.webp" className="rounded-lg" style={{width: "500px", height: "auto"}}/></Step>
    ...
    _Please note that this can take a few moments depending on your Asana account_.<img src="/help/images/integrations/asanaupdating.webp" className="rounded-lg" style={{width: "300px", height: "auto"}}/>
