...
| **Tasks:** Imported as Beebole Sub projects or Sub tasks. | **Billing Rates:** Managed exclusively in Beebole projects. |
...
<Steps>
    <Step title="Connect to Asana">Go to **Settings >> Integrations >> Asana**. Click on the button to connect to your Asana account.<br/><img src="/help/images/integrations/asana-connect.webp" className="rounded-lg" style={{width: "600px", height: "auto"}}/><br/>
    ...
    Define whether you want to import your tasks for Planning and assignment or for project time tracking and rates.<br/><img src="/help/images/integrations/asana-params.webp" className="rounded-lg" style={{width: "500px", height: "auto"}}/></Step>
    ...
    _Please note that this can take a few moments depending on your Asana account_.<img src="/help/images/integrations/asana-updating.webp" className="rounded-lg" style={{width: "300px", height: "auto"}}/>
