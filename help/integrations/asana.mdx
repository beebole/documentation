...
| Task | Sub-project | Sub-task |
| Sub-task | Sub-sub-project | Sub-sub-task |
...
| **Sub-tasks:** Imported as Beebole sub-sub-projects or sub-sub-tasks. | **Budgets:** Set within Beebole's billing and budget settings. |
