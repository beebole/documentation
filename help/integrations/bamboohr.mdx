...
<Info>You need administrative privileges in both BambooHR and Beebole to set up the integration.</Info>
...
<AccordionGroup>
  ...
  <Accordion title="Absence type mapping">
    ...
    <Warning>BambooHR's paid/unpaid setting is not carried over — all imported absences are created as paid in Beebole, even if the time-off type is unpaid in BambooHR. After the import, edit the created absence type in Beebole and adjust **Is paid (included in people costs)** to replicate the unpaid setting manually.</Warning>
  </Accordion>
...
<Steps>
  ...
  <Step title="Enable the integration">
    ...
    <Info>The initial import may take a few moments. A summary shows how many entries were successfully imported and lists any entries that could not be processed.</Info>
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Are unpaid BambooHR time-off types imported as unpaid in Beebole?">
