...
<Update label="August 2026" tags={["Reports","Budgets","Planning","Timesheet","Integrations","Settings","AI"]}>
  ...
  - Multi-select on the [Gantt](/help/documentation/gantt) and Staffing timelines: drag several bars together, hold ⌘/Alt to drop dated copies, or resize the whole selection at once — all undoable in a single step.
  - Lock the Gantt or Staffing view to a fixed week, month, quarter, or year fitted to your screen, and refill a period from the previous one with the new **Copy the previous period** action.
