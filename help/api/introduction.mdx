...
description: "Get started with the Beebole GraphQL API: how endpoints work, how to authenticate with an API key, and how to send your first query or mutation."
