...
description: "Learn how the Beebole GraphQL API works, how to authenticate with an API key, build queries and mutations, and run your first request from a terminal."
